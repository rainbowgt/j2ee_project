...
public class HiOrderService {
    ...
    public ArrayList<OrderBean> get_latest_hi(){
    ...
    public ArrayList<OrderBean> get_my_hi(int cur_iduser){
        IBookUserDaoImpl budi = new IBookUserDaoImpl();
        ResultSet rs = budi.order_select();
    ...
    public int request_order(BookHiBean bhb, int userid){
        int result = 0;
        OrderBean ob = new OrderBean();
        IBookUserDaoImpl bud = new IBookUserDaoImpl();
        //Book_Place_hi_Db_Impl bpld = new Book_Place_hi_Db_Impl();
        ob.setIduser(userid);
