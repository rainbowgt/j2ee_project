...
public class UserOrderHiServlet extends HttpServlet {
    ...
    private static String str_to_place(String place){
        String idplace="";
        if(place.equals("宋庆龄故居")){
            idplace = "8";
        }
        else if(place.equals("中共一大会址")){
            idplace = "9";
        }
        return idplace;
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("调用UserOrderHiServlet");
        BookHiBean blb = new BookHiBean();
        HiOrderService ols = new HiOrderService();
