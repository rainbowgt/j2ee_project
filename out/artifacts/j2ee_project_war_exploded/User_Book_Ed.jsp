...
<div id="fullscreen_bg" class="fullscreen_bg">
    <nav class="navbar navbar-default equinav" role="navigation" style="opacity: 0.8;">
        <div class="navbar-header">
            ...
            <span class="navbar-brand">黄浦区科普教育基地预约</span>
        </div><!-- /.navbar-header -->
    ...
    <div class="wrapper" style="margin: 10px; padding: 10px; opacity: 0.8;">
        ...
        <div class="container" style="margin-top:10px;padding-left: 0px;">
            <div style="margin: 15px">
                <a href="UserBookEdServlet">刷新</a>
            </div>
            <ul id="myTab" class="nav nav-tabs" style="background-color: #f8f8f8;margin-left: 15px;">
                <li class="active"><a href="#library" data-toggle="tab" style="width: 375px;">科普教育基地</a></li>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <table width="100%" class="table table-striped table-bordered table-hover" id="ed_order">
                                                        <thead>
                                                        <tr>
                                                            <th>预约场馆</th>
                                                            <th>预约时间</th>
                                                        ...
                                                        <%
                                                            ArrayList<BookEdBean> job= (ArrayList<BookEdBean>) request.getAttribute("list");
                                                            if(job!=null){
                                                                for(int i=0;i<job.size();i++){
                                                                    BookEdBean blb=(BookEdBean)job.get(i);
                                                        %>
                                                        <tr >
                                                            ...
                                                            <td><%=blb.getMax()%></td>
                                                            <td><a href="UserOrderEdServlet?idplace=<%=blb.getIdplace()%>&book_time=<%=blb.getTime()%>&vacancy=<%=blb.getVacancy()%>&userid=<%=ulb.getUserid()%>">预约</a> </td>
                                                        </tr>
                                                        <% }}
                                                        %>
                                                        </tbody>
                                                    ...
                                                    <div class="well" style="letter-spacing: 2px; line-height: 1.5;">
                                                        <h4>上海市黄浦区青少年活动中心</h4>
                                                        <p>黄浦区青少年活动中心创建于1960年，是黄浦区教育局的业务中介机构，中心在区教育局直接领导下，以促进学生个性健康发展为理念，
                                                            以追求“精、特、优”都市型精品教育为目标，以实施二期课改为契机，站在教育改革的前沿，积极探索，勇于实践，将校外教育与课内学习有机结合，
                                                            为未成年人健康成长搭建丰富多彩、展示才艺的教育平台。
                                                            <a target="_blank" href="http://www.shhpl.com/lib/Index.html">http://www.shhpl.com</a>.</p>
                                                        <a class="btn btn-default btn-lg btn-block" target="_blank" href="http://www.shhpl.com/lib/Index.html">前往上海市黄浦区青少年活动中心主页</a>
                                                    </div>
                                                </div>
                                                <!-- /.panel-body -->
                                            </div>
                            ...
                            <div class="fixed-table-header" style="display:table-header-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                若要查看待审核的预约以及所有预约历史，请点击 用户信息-历史订单 查看
                                            </div>
                                            <!-- /.panel-heading -->
                                            <div class="panel-body">
                                                <table width="100%" class="table table-striped table-bordered table-hover" id="my_order">
                                                    ...
                                                    <tr >
                                                        <%
                                                            String place="";
                                                            if(ob.getIdplace() == 10 && ob.getStatus() == 1){
                                                                place = "上海市黄浦区青少年活动中心";
                                                            }
                                                            else if(ob.getIdplace() == 11 && ob.getStatus() == 1){
                                                                place= "黄浦区科技馆";
                                                            }
                                                            else
                                                                continue;
                                                        ...
                                                        <td><%=place%></td>
                                                        <td><%=ob.getBook_time()%></td>
                                                        <td><a href="UserOrderSpServlet?del_idplace=<%=ob.getIdplace()%>&del_book_time=<%=ob.getBook_time()%>&del_userid=<%=ob.getIduser()%>">删除</a> </td>
                                                    </tr>
                                                    <% }}
                                                    %>
                                                    </tbody>
