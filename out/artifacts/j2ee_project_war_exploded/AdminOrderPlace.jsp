                    ...
                    <ul class="dropdown-menu depth_0" style="width:270px">
                        ...
                        <li>
                            <a href="#">
                                ...
                                <div>调试好辛苦，眼睛看瞎了QAQ .</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a class="text-center" href="AdminBoardServlet">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                            <%
                                ArrayList<PlaceShowBean> job= (ArrayList<PlaceShowBean>) request.getAttribute("list");
                                if(job!=null){
                                    System.out.println("!!!");}
                            %>
                            <%
                                ...
                                for(int i=0;i<job.size();i++){
                                    PlaceShowBean psb=(PlaceShowBean)job.get(i);
                                    if(psb!=null){
