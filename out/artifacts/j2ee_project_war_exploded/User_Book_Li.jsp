...
<div id="fullscreen_bg" class="fullscreen_bg">
    <nav class="navbar navbar-default equinav" role="navigation" style="opacity: 0.8;">
        <div class="navbar-header">
            ...
            <span class="navbar-brand">黄浦区图书馆预约</span>
        </div><!-- /.navbar-header -->
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="User_Book.jsp">预约首页</a></li>
                <li><a href="UserBookSpServlet">体育馆预约</a></li>
    ...
    <div class="wrapper" style="margin: 10px; padding: 10px; opacity: 0.8;">
        ...
        <div class="container" style="margin-top:10px;padding-left: 0px;">
            <div style="margin: 15px">
                <a href="UserBookLiServlet">刷新</a>
            </div>
            <ul id="myTab" class="nav nav-tabs" style="background-color: #f8f8f8;margin-left: 15px;">
                <li class="active"><a href="#library" data-toggle="tab" style="width: 375px;">图书馆</a></li>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <table width="100%" class="table table-striped table-bordered table-hover" id="li_order">
                                                        <thead>
                                                        <tr>
                                                            <th>预约场馆</th>
                                                            <th>房间号</th>
                                                        ...
                                                        <%
                                                            ArrayList<BookLiBean> job= (ArrayList<BookLiBean>) request.getAttribute("list");
                                                            if(job!=null){
                                                                for(int i=0;i<job.size();i++){
                                                                    BookLiBean blb=(BookLiBean)job.get(i);
                                                        %>
                                                        <tr >
                                                            ...
                                                            <td><%=blb.getMax()%></td>
                                                            <td><a href="UserOrderLiServlet?idplace=<%=blb.getIdplace()%>&idroom=<%=blb.getIdroom()%>&book_time=<%=blb.getTime()%>&vacancy=<%=blb.getVacancy()%>&userid=<%=ulb.getUserid()%>">预约</a> </td>
                                                        </tr>
                                                        <% }}
                                                        %>
                                                        </tbody>
                                                    ...
                                                    <div class="well" style="letter-spacing: 2px; line-height: 1.5;">
                                                        <h4>黄浦区图书馆咨询</h4>
                                                        <p>上海市黄浦区图书馆坐落在上海中心城区，建筑面积13122平方米，是国家一级图书馆、全国文化先进单位、上海市文明单位。
                                                            黄浦区图书馆是对所有人敞开大门的公共图书馆。它是上海市公共图书馆网络中的一员。每周开放时间71.5小时。
                                                            目前，黄浦区图书馆拥有藏书100万余册，分设普通图书借阅室、报刊杂志阅览室、少儿图书借阅室、旅游文化博览室、上海文学专题室、
                                                            地方文献室、电子阅览室、俄罗斯室等专题阅览室， 设计座位数为五百个。 <a target="_blank" href="http://www.shhpl.com/lib/Index.html">http://www.shhpl.com</a>.</p>
                                                        <a class="btn btn-default btn-lg btn-block" target="_blank" href="http://www.shhpl.com/lib/Index.html">前往黄浦区图书馆主页</a>
                                                    </div>
                                                </div>
                                                <!-- /.panel-body -->
                                            </div>
                                                ...
                                                <div class="panel-body">
                                                    <table width="100%" class="table table-striped table-bordered table-hover" id="latest_order">
                                                        ...
                                                        <tr >
                                                            <%
                                                                int place=0;
                                                                if(ob.getIdplace()==1 || ob.getIdplace()==2 || ob.getIdplace()==3 || ob.getIdplace()==4){
                                                                    place = ob.getIdplace();
                                                                }
                                                                else
                                                                    continue;
                                            ...
                                            <div class="panel-body">
                                                <table width="100%" class="table table-striped table-bordered table-hover" id="my_order">
                                                    ...
                                                    <tr >
                                                        <%
                                                            int place=0;
                                                            if( (ob.getIdplace()==1 || ob.getIdplace()==2 || ob.getIdplace()==3 || ob.getIdplace()==4)  && ob.getStatus() == 1){
                                                                place = ob.getIdplace();
                                                            }
                                                            else
                                                                continue;
                                                        ...
                                                        <td><%=ob.getIdroom()%>室</td>
                                                        <td><%=ob.getBook_time()%></td>
                                                        <td><a href="UserOrderLiServlet?del_idplace=<%=ob.getIdplace()%>&del_idroom=<%=ob.getIdroom()%>&del_book_time=<%=ob.getBook_time()%>&del_userid=<%=ob.getIduser()%>">删除</a> </td>
                                                    </tr>
                                                    <% }}
                                                    %>
                                                    </tbody>
